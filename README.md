...
さよよプレイヤーでは **[YouTube Data API](https://developers.google.com/youtube/v3/getting-started)** を使用して過去の配信データを取得し、タイムスタンプ付きで曲の情報を表示します。動画は **[YouTube IFrame Player API](https://developers.google.com/youtube/iframe_api_reference)** を利用して埋め込みます。
